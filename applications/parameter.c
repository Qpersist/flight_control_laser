...
//	PID_Para_Init();
	...
	Delay_ms(10);
	AT24cxx_read_PID_hight_Rate();
	Delay_ms(10);
	AT24cxx_read_PID_CCD();
	AT24cxx_read_PID_others();
...
// Para_WriteSettingToFile();
	...
	AT24cxx_save_PID_hight_Rate();
	
	AT24cxx_save_PID_hight();
	
	AT24cxx_save_PID_CCD();
	AT24cxx_save_PID_others();
