...
//	Delay_ms(10);
	...
	Delay_ms(10);
	MPU6050_setFullScaleAccelRange(MPU6050_ACCEL_FS_2);	//加速度度最大量程 +-8G
	Delay_ms(10);
	MPU6050_setDLPF(default_filter);  //42hz
	Delay_ms(10);
//	IIC_Write_1Byte(MPU6050_ADDR,0X37,0x42);
//	Delay_ms(10);
//	IIC_Write_1Byte(MPU6050_ADDR,0X6A,0x40);
//	MPU6050_setI2CMasterModeEnabled(0);	 //不让MPU6050 控制AUXI2C
//	Delay_ms(10);
//	MPU6050_setI2CBypassEnabled(1);	 //主控制器的I2C与	MPU6050的AUXI2C	直通。控制器可以直接访问HMC5883L
//	Delay_ms(10);
	IIC_Write_1Byte(MPU6050_ADDR,MPU6050_RA_INT_PIN_CFG,0x42);
	IIC_Write_1Byte(MPU6050_ADDR,MPU6050_RA_USER_CTRL,0x40);
}
...
void MPU6050_Data_Offset()
{
	...
	{
		GY_530.ACC_z_zero = mpu6050.Acc.z;
...
//10 170 4056
	...
	mpu6050.TEMP_Acc_I16.x = mpu6050_tmp[A_X] ;
	mpu6050.TEMP_Acc_I16.y = mpu6050_tmp[A_Y] ;
	mpu6050.TEMP_Acc_I16.z = mpu6050_tmp[A_Z] ;
...
/****************************************************/
	...
	imuAccIIRLPFilter(&mpu6050.TEMP_Acc_I16, //int16  xyz
				  &accelLPF, //int16 xyz
