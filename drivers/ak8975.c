...
//				HMC5883_Offset_Y = 0,
//				HMC5883_Offset_Z = 0;
u8 ANO_AK8975_Run(void)
{
//	u8 tempA ,tempB ,tempC;
	
//	HCM_IIC_Write_1Byte(AK8975_ADDRESS,0x00,0x70);	
//	HCM_IIC_Write_1Byte(AK8975_ADDRESS,0x01,0x20);	
    return HCM_IIC_Write_1Byte(AK8975_ADDRESS,0x02,0x01);
...
//	I2C_FastMode = 0;
	...
	HCM_IIC_Read_1Byte(AK8975_ADDRESS,AK8975_HXL,&ak8975_buffer[0]); 
	HCM_IIC_Read_1Byte(AK8975_ADDRESS,AK8975_HXH,&ak8975_buffer[1]);
	mag_temp[1] = ((((int16_t)ak8975_buffer[1]) << 8) | ak8975_buffer[0]) ;  //磁力计X轴

	HCM_IIC_Read_1Byte(AK8975_ADDRESS,AK8975_HYL,&ak8975_buffer[2]);
	HCM_IIC_Read_1Byte(AK8975_ADDRESS,AK8975_HYH,&ak8975_buffer[3]);
	mag_temp[0] = ((((int16_t)ak8975_buffer[3]) << 8) | ak8975_buffer[2]) ;  //磁力计Y轴

	HCM_IIC_Read_1Byte(AK8975_ADDRESS,AK8975_HZL,&ak8975_buffer[4]);
	HCM_IIC_Read_1Byte(AK8975_ADDRESS,AK8975_HZH,&ak8975_buffer[5]);
