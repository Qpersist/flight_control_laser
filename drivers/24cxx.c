...
void AT24cxx_save_Acc_Gyro_offest(void)
{
	...
	IIC_ADD_writelen_BYTE(save_gyro_x,(int)(mpu6050.Gyro_Offset.x) *100,2);
	IIC_ADD_writelen_BYTE(save_gyro_y,(int)(mpu6050.Gyro_Offset.y *100),2);
	IIC_ADD_writelen_BYTE(save_gyro_z,(int)(mpu6050.Gyro_Offset.z) *100,2);
...
void AT24cxx_read_Acc_Gyro_offest(void)
{
	...
	mpu6050.Gyro_Offset.x=IIC_Read_MultiBytes(0xA0,save_gyro_x,2) /100.0f;
	mpu6050.Gyro_Offset.y=IIC_Read_MultiBytes(0xA0,save_gyro_y,2) /100.0f;
	mpu6050.Gyro_Offset.z=IIC_Read_MultiBytes(0xA0,save_gyro_z,2) /100.0f;
