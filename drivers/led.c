...
void LED_Duty() //50ms一次
{
	static u8 led_count=0,led_count2;
	static u8 led_flag=0;
	static u8 led2_HZ,led2_count;
	LED1_ON;
	led2_count++;
	if(led2_count ==20)
	{
...
//		LED3_ON;
	...
	if((change_CCD_data == 1)&&(led_flag != 1))
	{
		led_count++;
		led_count2=0;
		if((led_count /10%2 !=0))
